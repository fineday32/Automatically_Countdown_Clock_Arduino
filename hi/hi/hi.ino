...
//  int hour1 = hour(t)/10;
//  int hour2 = hour(t)%10;
//  int minute1 = minute(t)/10;
//  int minute2 = minute(t)%10;
//  int second1 = second(t)/10;
//  int second2 = second(t)%10;
//  char c = 2 +'0';
//  setChar((hour1+'0'), 15, 15, BLACK);
//  setChar((hour2+'0'), 21, 15, BLACK);
//  setChar(':', 30, 15, BLACK);
//  setChar((minute1+'0'), 39, 15, BLACK);
//  setChar((minute2+'0'), 45, 15, BLACK);
//  setChar(':', 54, 15, BLACK);
//  setChar((second1+'0'), 63, 15, BLACK);
//  setChar((second2+'0'), 69, 15, BLACK);
//  //  setStr("BBBB of stars", 0, 15, BLACK);
//  updateDisplay();
//  delay(1000);

Serial.print(countTimesUp);
  Serial.print(timesUp);
  
if (timesUp==true&&h==0&&m==0&&s==0)
{
  if (countTimesUp==3)
  {
    countTimesUp = -2;
...
countDownTime();
  setChar((h/10+'0'), 15, 15, BLACK);
  setChar((h%10+'0'), 21, 15, BLACK);
  setChar(':', 30, 15, BLACK);
  setChar((m/10+'0'), 39, 15, BLACK);
  setChar((m%10+'0'), 45, 15, BLACK);
  setChar(':', 54, 15, BLACK);
  setChar((s/10+'0'), 63, 15, BLACK);
  setChar((s%10+'0'), 69, 15, BLACK);
  updateDisplay();
  delay(1000);
